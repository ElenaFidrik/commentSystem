...
// обработчик кнопки
public sending() {                                                   
    this.btn?.addEventListener('click', function(): void {
        comm.commentContent();
    })
}
...
public commentContent() {
    ...
    input.count.innerText = `Макс. ${input.limit} символов`;     
...
//отрисовка сердечка
public drawHeart(like: any): string {                 
